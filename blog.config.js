...
const BLOG = {
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://activereadings.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, 英语, English, Language Learning', // 网站关键词 英文逗号隔开
