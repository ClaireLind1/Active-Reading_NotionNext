...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '5cdf0a825aaf4ec0850cae445c20107e',
  ...
  GREETING_WORDS:
    ...
    'Hi，我是译员ClaireLind, 欢迎来到Active Reading🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Active Reading', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'ClaireLind', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.activereadings.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, Blog, 英语, English, Language Learning', // 网站关键词 英文逗号隔开
  ...
  CONTACT_XIAOHONGSHU: process.env.NEXT_PUBLIC_CONTACT_XIAOHONGSHU || 'https://www.xiaohongshu.com/user/profile/5c4dd2b6000000001201c81b', // 小红书主页
